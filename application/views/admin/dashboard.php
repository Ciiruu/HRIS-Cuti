                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-success">
                                ...
                                <a href="<?= base_url(); ?>Cuti/view_admin_accepted_cuti" class="small-box-footer">More info 
                                    <i class="fas fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-danger">
                                ...
                                <a href="<?= base_url(); ?>Cuti/view_admin_reject_cuti" class="small-box-footer">More info 
                                    <i class="fas fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-warning">
                                ...
                                <a href="<?= base_url(); ?>Cuti/view_admin_waiting_cuti" class="small-box-footer">More info 
                                    <i class="fas fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
