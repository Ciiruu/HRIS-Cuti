<aside class="main-sidebar sidebar-dark-primary elevation-3">
    <!-- Brand Logo -->
    <a href="<?= base_url();?>Dashboard/dashboard_pegawai" class="brand-link">
        <img src="<?= base_url();?>assets/login/images/GDHY.png" alt="AdminLTE Logo"
            class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">GDHY</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="<?= base_url();?>Dashboard/dashboard_pegawai" class="d-block"><?=$this->session->userdata('username');?></a>
            </div>
        </div>
